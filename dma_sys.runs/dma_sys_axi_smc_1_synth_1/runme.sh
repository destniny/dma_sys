...
HD_PWD='D:/Developer/dma_sys/dma_sys.runs/dma_sys_axi_smc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_sys_axi_smc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_sys_axi_smc_1.tcl
